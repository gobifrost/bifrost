...
vi.mock("@/services/schedulerDiagnostics", async () => {
	...
	return {
		...
		getSchedulerDiagnostics: vi.fn().mockResolvedValue({
			...
			replicas: [{ id: "scheduler-a", hostname: "scheduler-1", pid: 1, is_leader: true, online: true, started_at: "2026-08-05T21:00:00Z", last_heartbeat_at: "2026-08-05T22:00:00Z", memory_current_bytes: 900, memory_limit_bytes: 1000, active_platform_job_id: null }],
