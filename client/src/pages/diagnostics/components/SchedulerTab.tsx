	...
	return (
		<div className="max-w-[1100px] mx-auto space-y-6" data-testid="scheduler-diagnostics">
			...
			<Card>
				...
				<CardContent>
					<Table><TableHeader><TableRow><TableHead>Replica</TableHead><TableHead>Role</TableHead><TableHead>Status</TableHead><TableHead>Memory</TableHead><TableHead>Active job</TableHead></TableRow></TableHeader>
						<TableBody>{data.replicas.map((replica) => <TableRow key={replica.id}>
							...
							<TableCell className="font-mono text-xs">{replica.active_platform_job_id ?? "Idle"}</TableCell>
