...
The package is instance-served, not public-npm-published. Local apps install it from the target Bifrost instance URL; deployed source-built Solution apps get the same SDK as a local `file:./bifrost-sdk.tgz` generated by the server-side build. See `docs/runbooks/web-sdk.md` for the source, versioning, and update story.
