...
| GET | `/api/agent-evaluations/agents/{agent_id}/tests` |
| POST | `/api/agent-evaluations/agents/{agent_id}/tests` |
| POST | `/api/agent-evaluations/agents/{agent_id}/tests/generate` |
| GET | `/api/agent-evaluations/agents/{agent_id}/tests/latest` |
| POST | `/api/agent-evaluations/agents/{agent_id}/tests/run` |
| GET | `/api/agent-evaluations/agents/{agent_id}/tests/{logical_test_id}` |
| PATCH | `/api/agent-evaluations/agents/{agent_id}/tests/{logical_test_id}` |
| POST | `/api/agent-evaluations/candidates` |
| GET | `/api/agent-evaluations/candidates/{candidate_id}` |
| GET | `/api/agent-evaluations/designer-runs/{run_id}/usage` |
| POST | `/api/agent-evaluations/executions` |
| POST | `/api/agent-evaluations/executions/batch` |
| GET | `/api/agent-evaluations/executions/batch/{matrix_id}` |
| POST | `/api/agent-evaluations/executions/batch/{matrix_id}/cancel` |
| GET | `/api/agent-evaluations/executions/{execution_id}` |
| POST | `/api/agent-evaluations/executions/{execution_id}/cancel` |
| GET | `/api/agent-evaluations/executions/{execution_id}/results` |
| GET | `/api/agent-evaluations/executions/{execution_id}/usage` |
| POST | `/api/agent-evaluations/recorded-evaluations` |
| GET | `/api/agent-evaluations/recorded-evaluations/{evaluation_id}/results` |
| GET | `/api/agent-evaluations/recorded-evaluations/{evaluation_id}/usage` |
| GET | `/api/agent-evaluations/suites` |
| POST | `/api/agent-evaluations/suites` |
| GET | `/api/agent-evaluations/suites/{suite_id}` |
| PUT | `/api/agent-evaluations/suites/{suite_id}` |
| GET | `/api/agent-evaluations/suites/{suite_id}/cases` |
| POST | `/api/agent-evaluations/suites/{suite_id}/cases` |
| POST | `/api/agent-evaluations/suites/{suite_id}/cases/accept` |
| PUT | `/api/agent-evaluations/suites/{suite_id}/cases/{case_id}` |
| POST | `/api/agent-evaluations/suites/{suite_id}/designer/drafts` |
| POST | `/api/agent-evaluations/suites/{suite_id}/publish` |
| GET | `/api/agent-findings` |
| POST | `/api/agent-findings` |
| GET | `/api/agent-findings/search` |
| GET | `/api/agent-findings/{finding_id}` |
| PATCH | `/api/agent-findings/{finding_id}` |
| GET | `/api/agent-reviews` |
| POST | `/api/agent-reviews` |
| GET | `/api/agent-reviews/runs/{review_run_id}` |
| GET | `/api/agent-reviews/runs/{review_run_id}/results` |
| GET | `/api/agent-reviews/runs/{review_run_id}/usage` |
| GET | `/api/agent-reviews/{review_id}` |
| PATCH | `/api/agent-reviews/{review_id}` |
| POST | `/api/agent-reviews/{review_id}/runs` |
| GET | `/api/agent-reviews/{review_id}/versions` |
| POST | `/api/agent-reviews/{review_id}/versions` |
| GET | `/api/agent-runs` |
...
| GET | `/api/recurring-triggers` |
| POST | `/api/recurring-triggers` |
| GET | `/api/recurring-triggers/{trigger_id}` |
| PATCH | `/api/recurring-triggers/{trigger_id}` |
| GET | `/api/recurring-triggers/{trigger_id}/fires` |
...
| GET | `/api/reports/usage/breakdown` |
