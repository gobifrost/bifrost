...
from src.jobs.platform.solution_builder_turn import SOLUTION_BUILDER_TURN_DEFINITION
...
_DEFINITIONS = {
    ...
    SANDBOX_RUNNER_PROVISION_DEFINITION.job_type: SANDBOX_RUNNER_PROVISION_DEFINITION,
    SOLUTION_BUILD_DEFINITION.job_type: SOLUTION_BUILD_DEFINITION,
    SOLUTION_BUILDER_TURN_DEFINITION.job_type: SOLUTION_BUILDER_TURN_DEFINITION,
