...
from src.jobs.platform.agent_evaluation import AGENT_EVALUATION_SUITE_DEFINITION
...
_DEFINITIONS = {
    ...
    AGENT_EVALUATION_SUITE_DEFINITION.job_type: AGENT_EVALUATION_SUITE_DEFINITION,
    SYNTHETIC_SEMANTIC_JUDGE_DEFINITION.job_type: SYNTHETIC_SEMANTIC_JUDGE_DEFINITION,
    AGENT_REVIEW_DEFINITION.job_type: AGENT_REVIEW_DEFINITION,
    AGENT_RECORDED_EVALUATION_DEFINITION.job_type: AGENT_RECORDED_EVALUATION_DEFINITION,
    AGENT_RECORDED_SEMANTIC_EVALUATION_DEFINITION.job_type: AGENT_RECORDED_SEMANTIC_EVALUATION_DEFINITION,
