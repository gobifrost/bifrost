...
class UserPrincipal:
    ...
    def has_scope(self, scope: str) -> bool:
        """Whether the principal has an authorization scope.

        The stored superuser bit contributes the compatibility wildcard until
        role-backed Platform Admin is the sole authority.
        """
