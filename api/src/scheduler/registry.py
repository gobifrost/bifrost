...
SCHEDULED_TASKS: tuple[ScheduledTaskDefinition, ...] = (
    ...
    ScheduledTaskDefinition("agent_run_recovery", "Resume Due or Interrupted Agent Runs", "Every 15 seconds"),
    ScheduledTaskDefinition("agent_completion_events", "Publish Agent Completion Events", "Every minute"),
    ScheduledTaskDefinition("agent_evaluation_reconciliation", "Reconcile Agent Evaluations", "Every minute"),
    ...
    ScheduledTaskDefinition("recurring_trigger_processor", "Process Recurring PlatformJob Triggers", "Every minute"),
)
