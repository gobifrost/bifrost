"""Legacy Role authorization-field translation.

This module is imported by the DB migration and by public input parsers so
old Role payloads, old manifests, and upgraded rows resolve identically.
"""
